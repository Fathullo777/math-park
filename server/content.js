/** Контент парка — тексты простые, для 1–4 класса */
...
const attractions = [
  ...
  },
  {
    ...
    problems: [
      {
        id: 'g1',
        prompt: 'У треугольника…',
        options: ['3 стороны', '4 стороны', 'нет углов'],
        answer: '3 стороны',
      },
      {
        id: 'g2',
        prompt: 'У квадрата…',
        options: ['3 стороны', '4 равные стороны', 'нет углов'],
        answer: '4 равные стороны',
      },
      {
        id: 'g3',
        prompt: 'У прямоугольника…',
        options: ['4 угла по 90°', 'нет углов', '3 стороны'],
        answer: '4 угла по 90°',
      },
      {
        id: 'g4',
        prompt: 'У круга…',
        options: ['4 стороны', 'нет углов', '3 стороны'],
        answer: 'нет углов',
      },
    ],
    pointsPerCorrect: 12,
    ...
    problems: [
      {
        id: 'f1',
        prompt: 'Знак «=» значит…',
        options: ['Равно', 'Больше', 'Меньше'],
        answer: 'Равно',
      },
      {
        id: 'f2',
        prompt: 'Ноль — это…',
        options: ['Ничего', 'Десять', 'Сто'],
        answer: 'Ничего',
      },
      {
        id: 'f3',
        prompt: 'У круга есть углы?',
        options: ['Нет', 'Да', 'Только один'],
        answer: 'Нет',
      },
    ],
    pointsPerCorrect: 12,
...
const facts = [
  {
    title: 'Магия числа 9',
    text: '9 + 9 = 18, а 1 + 8 = 9. Снова девятка!',
    emoji: '✨',
  },
  {
    title: 'Пицца и доли',
    text: 'Пиццу разрезали на 4 части. Одна часть — это 1/4.',
    emoji: '🍕',
  },
  {
    title: 'Симметрия',
    text: 'Бабочка похожа слева и справа — это симметрия!',
    emoji: '🦋',
  },
  {
    title: 'Число π',
    text: 'π помогает измерять круги. Оно начинается так: 3,14…',
    emoji: '🔵',
  },
  {
    title: 'Быстрый счёт',
    text: '5 + 5 легче считать как «две пятёрки» — это 10!',
    emoji: '⚡',
  },
  {
    title: 'Чётные числа',
    text: '2, 4, 6, 8 — чётные. Их можно делить пополам поровну.',
    emoji: '2️⃣',
  },
];
...
const finalQuiz = [
  {
    id: 'q1',
    prompt: 'Сколько будет 8 × 5?',
    options: ['35', '40', '45'],
    answer: '40',
  },
  {
    id: 'q2',
    prompt: 'У какой фигуры 3 стороны?',
...
const REQUIRED_ATTRACTIONS = attractions.map((a) => a.id);
...
function findAttractionProblem(attractionId, problemId) {
  const a = getAttraction(attractionId);
  if (!a) return null;
  const problem = a.problems.find((p) => p.id === problemId);
  return problem ? { attraction: a, problem } : null;
}

function findQuizProblem(problemId) {
  return finalQuiz.find((q) => q.id === problemId) || null;
}

/** Книга ответов для учителя / родителя */
